...
### 3xl分组（超大桌面设备）
- 1920x911, 1912x954, 2048x983, 2048x1158
- 1920x1080, 1920x852, 1912x1002, 1912x860
- 2040x996, 2040x1026, 2195x1147, 2195x1066
- 2000x1000, 2505x1316, 2327x1163, 2187x1079
...
### 性能优化
- **智能延迟加载**：进入视口1.5秒后才加载iframe，离开视口8秒后自动卸载
- **内存管理**：切换分组时清理旧iframe，避免内存泄漏
- **活跃iframe限制**：最多同时保持10个活跃iframe，自动卸载最久未访问的
- **分页限制**：网格模式每页最多8个设备，避免浏览器崩溃
- **视口优化**：竖版模式下所有设备可见，但只有视口内的才会加载
